...
import { createUserReviewAPI, getLocationReviewById } from "@/utils/http"
import { DatePicker, Form, Input, message, Rate, Select } from "antd"
...
export const LocationReviewPage = ({ ...props }: LocationReviewProps) => {
  ...
  const handleFormSubmit = async (values: any) => {
    const data = {
      ...values,
      trip_time: values.trip_time.format("DD-MM-YYYY"),
    ...
    setLoading(true)
    try {
      const res = await createUserReviewAPI(data)
      setLoading(false)
